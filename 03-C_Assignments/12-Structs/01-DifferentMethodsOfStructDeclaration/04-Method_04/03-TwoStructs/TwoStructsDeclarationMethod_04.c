...
int main(void)
{
    ...
    struct MyPoint point_SSP; //declaraing a single variable of type 'struct MyPoint' locally...

    struct MyPointProperties point_properties_SSP; //declaraing a single variable of type 'struct MyPointProperties' locally...
