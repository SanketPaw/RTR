...
int main(void)
{
    ...
    struct MyPoint
    {
        int x_SSP;
        int y_SSP;
    } point_SSP; //declaring a single variable of type 'struct MyPoint' locally...
    ...
    } point_properties_SSP; //declaring a single variable of type 'struct MyPointProprties' locally...
