...
void display(void)
{
	...
	mat4 rotationMatrix_x = vmath::rotate(angleCube, 1.0f, 0.0f, 0.0f);
	mat4 rotationMatrix_y = vmath::rotate(angleCube, 0.0f, 1.0f, 0.0f);
	mat4 rotationMatrix_z = vmath::rotate(angleCube, 0.0f, 0.0f, 1.0f);
