...
int initialize(void)
{
	...
	//VAO and VBO related code
	 glGenVertexArrays(1, &VAO_Triangle);//1 VAO
	 ...
	 glBufferData(GL_ARRAY_BUFFER,
		 sizeof(trianglePosition), trianglePosition, GL_STATIC_DRAW);
	 ...
	 glBufferData(GL_ARRAY_BUFFER,
		 sizeof(triangleColor), triangleColor, GL_STATIC_DRAW);
	 ...
	 //data bharaychay target cha side ni liha GL_STATIC_DRAW->attach bhar data
	 glBufferData(GL_ARRAY_BUFFER,
		 sizeof(squarePosition), squarePosition, GL_STATIC_DRAW);
