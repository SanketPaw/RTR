...
void drawConcentricCircles(int numberOfCircles)
{
	...
	GLfloat step = 0.8f / numberOfCircles;
	GLfloat circlePoints = 10000;
	GLfloat angle = 0.0f;
	...
	{
		GLfloat radius = (step * (counter + 1));

		glBegin(GL_LINE_LOOP);

		glColor3f(colors[counter % 7][0], colors[counter % 7][1], colors[counter % 7][2]);

		for (int pointFlag = 0; pointFlag < circlePoints; ++pointFlag)
		{
			angle = 2.0f * M_PI * pointFlag / circlePoints;
